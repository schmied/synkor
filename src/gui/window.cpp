...
window::window(QWidget *parent) :
	...
	rl_item_left_ = new item_view {ui_->rl_item_left_tree, ui_->rl_item_left_list, ui_->rl_item_left_label, ui_->status_bar};
	ui_->rl_item_left_tree->set_item_view(rl_item_left_);
	ui_->rl_item_left_list->set_item_view(rl_item_left_);
	rl_item_right_ = new item_view {ui_->rl_item_right_tree, ui_->rl_item_right_list, ui_->rl_item_right_label, ui_->status_bar};
